...
def _main_menu_keyboard(has_accounts: bool, bot_running: bool) -> str:
    ...
    if has_accounts:
        if bot_running:
            rows.append([_raw_btn("Stop Bot", "stop_bot", "destructive")])
        else:
            rows.append([_raw_btn("Start Bot", "start_bot", "positive")])
    ...
    if has_accounts:
        rows.append([_raw_btn("Delete All Accounts", "delete_accounts", "destructive")])
    rows.append([_raw_btn("Delete All Volume Data", "delete_volume", "destructive")])
